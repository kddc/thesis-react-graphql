let resolvers = {
  ...
  Question: {
    ...
    answers: ({ answers }, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceList('Answer', answers, args)
    }
  },
  Comment: {
    author: ({ author }, args, { baqendResolver }) => {
  ...
  AddAnswerToQuestionAnswersPayload: {
    author: ({ author }, args, { baqendResolver }) => {
      return baqendResolver.resolveReference('User', author, args)
    },
    answers: ({ answers }, args, { baqendResolver }) => {
  ...
  RemoveAnswerFromQuestionAnswersPayload: {
    author: ({ author }, args, { baqendResolver }) => {
      return baqendResolver.resolveReference('User', author, args)
    },
    answers: ({ answers }, args, { baqendResolver }) => {
  ...
  Query: {
    ...
    Question: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Question', args, {})
    },
    allQuestions: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceCollectionQuery('Question', args, {})
    },
    ...
    Answer: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceQuery('Answer', args, {})
    },
    allAnswers: (root, args, { baqendResolver }) => {
      return baqendResolver.resolveReferenceCollectionQuery('Answer', args, {})
    },
  ...
  Mutation: {
    ...
    createQuestion: (root, args, { baqendMutator }) => {
      return baqendMutator.createEntity('Question', args, {})
    },
    updateQuestion: (root, args, { baqendMutator }) => {
      return baqendMutator.updateEntity('Question', args, {})
    },
    deleteQuestion: (root, args, { baqendMutator }) => {
      return baqendMutator.deleteEntity('Question', args, {})
    },
    addAnswerToQuestionAnswers: (root, args, { baqendMutator }) => {
      return baqendMutator.addEntryToCollection('Question', 'answers', args, {})
    },
    removeAnswerFromQuestionAnswers: (root, args, { baqendMutator }) => {
      return baqendMutator.removeEntryFromCollection('Question', 'answers', args, {})
    },
    ...
    createAnswer: (root, args, { baqendMutator }) => {
      return baqendMutator.createEntity('Answer', args, {})
    },
    updateAnswer: (root, args, { baqendMutator }) => {
      return baqendMutator.updateEntity('Answer', args, {})
    },
    deleteAnswer: (root, args, { baqendMutator }) => {
      return baqendMutator.deleteEntity('Answer', args, {})
    },
